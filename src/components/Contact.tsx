...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/romeo-shamoun-5958b910a/',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
const contactInfo = [
  ...
  },
  {
    ...
    title: 'Onyx Tech Solutions',
    value: 'Check us out on Notion',
    link: 'https://onyxtechsolutions.notion.site/index'
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-3 bg-white/5 rounded-lg text-gray-400 transition-colors ${social.color} hover:bg-white/10`}
                  >
                    {social.icon}
                  </motion.a>
                ))}
